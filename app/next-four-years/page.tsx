    ...
    <div className="max-w-4xl mx-auto my-20 md:my-4">
      <div className="max-w-4xl mx-4">
        ...
        <div className="flex flex-row items-center justify-center space-x-4">
          <p className="text-xs text-center text-gray italic">Sean Cavanaugh</p>
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className={"text-base indent-1"}>
              ...
              legislators; lure investment; developers; and locals and outsiders
              to build, remodel and update housing. Those who can fix this
            ...
            <p className={"text-base indent-1"}>
              ...
              town. The South side has so much to offer, and parts are like a
